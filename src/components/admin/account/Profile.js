...
class Profile extends Component {
  ...
  render() {
    ...
    if (
      (this.state.emailValue && !this.state.emailValid) ||
      this.state.emailValue == ""
    ) {
      emailErrorMessage = (
        <Alert color="danger">Email address is invalid.</Alert>
      );
    } else {
      emailErrorMessage = "";
    }
        ...
        <Col sm="12" md="9">
          <Form>
            ...
            <Button
              ...
              color={
                this.state.buttons.appNotifications ? "primary" : "secondary"
              }
            >
            ...
            <Button
              ...
              className="float-right"
              color={
                this.state.buttons.emailNotifications ? "primary" : "secondary"
              }
            >
